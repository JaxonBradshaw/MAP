# Generated by Django 3.1.1 on 2020-12-06 04:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ethnicity', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='User.ethnicity')),
                ('state_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='User.state')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
